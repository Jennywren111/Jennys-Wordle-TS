...
// Move this class to a module
class GuessProcessor {

    // Need a method that checks if max number of guesses has been reached, or actually would this be done in the main.ts file?

    markCorrectGuesses() {
        // this is the markCorrectMatches function
    }

    markSemicorrectGuesses() {
        // this is the markSemicorrectMatches function
    }


}

// Instantiate guess processor, call its functions in appropriate order?
